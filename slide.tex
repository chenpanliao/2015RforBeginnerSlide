...
%    \setbeamercolor{frametitle}{fg=black, bg=black!80}
...
\setmonofont[Color=verb, Scale=0.95, LetterSpace=-1, BoldFeatures={Color=white}, BoldFont={Consolas}]{Consolas}
...
\setbeamertemplate{title page}{
  \vskip0pt plus 1filll
    \huge{初學\hspace{0.2em}\includegraphics[width=3cm]{Rlogo-novo.pdf}\hspace{0.2em}語言的60分鐘}\\[20pt]
    \normalsize{廖鎮磐 \texttt{<andrew.43@gmail.com>}\\東海大學生命科學系}\\[10pt]
    \normalsize{2015年台灣生態研究網年會\\ 2015年3月14日於蓮華池研究中心}\\[10pt]
    \vskip0pt plus 0.5filll
    \tiny{
     \includegraphics[width=2cm]{cc.pdf} \newline
	 本文件採用姓名標示-相同方式分享 4.0 國際授權（CC BY-SA 4.0，詳情請見 \url{http://creativecommons.org/licenses/by-sa/4.0/deed.zh_TW}）。}\\
	\tiny{下載本投影片及資料檔案：\url{https://www.dropbox.com/sh/7p9cluglptyk25a/AAAmPWrSMVf_tC9-cL4JSscCa?dl=0} 
	}
}
