...
\textattachfile[appearance=false, mimetype="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]{nation-data.xlsx}{}
    ...
    {\footnotesize
        ...
        \parbox[c]{9cm}{% 
           © 2015 廖鎮磐（Chen-Pan Liao）。本文件採用姓名標示-相同方式分享 4.0 國際授權（CC BY-SA 4.0），\footnote{\url{http://creativecommons.org/licenses/by-sa/4.0/deed.zh_TW}。}歡迎\href{http://goo.gl/foAeaq}{下載本投影片及練習資料檔案}。\footnote{\url{http://goo.gl/foAeaq}}以Adobe Reader開啟本PDF亦可取得練習資料檔案附件。
	 }% 
	 \vspace{10pt}
    }
}
