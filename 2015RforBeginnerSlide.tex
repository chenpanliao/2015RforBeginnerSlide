...
\DefineVerbatimEnvironment{R}{Verbatim}{fontsize=\footnotesize, frame=single, baselinestretch=0.9, samepage=true}
...
\setmonofont[Color=codecolor, Scale=0.82, LetterSpace=-2, BoldFeatures={Color=codecolor}, BoldFont={Source Code Pro Semibold}]{Source Code Pro Semibold}
...
\setbeamertemplate{title page}{
  \vskip0pt plus 1filll
    \LARGE{\bfseries\usebeamercolor[fg]{title}初學\hspace{0.2em}\includegraphics[width=3cm]{Rlogo-novo.png}\hspace{0.2em}語言的60分鐘}\\[0pt]
...
\textattachfile[appearance=false, mimetype="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"]{nation-data.xlsx}{}
    ...
    \large{廖鎮磐 \texttt{<andrew.43@gmail.com>}\\[-5pt] \small 東海大學生命科學系}\\[5pt]
    ...
    {\footnotesize
        ...
        \parbox[c]{9cm}{% 
           © 2015 廖鎮磐（Chen-Pan Liao）。本文件採用\href{http://creativecommons.org/licenses/by-sa/4.0/deed.zh_TW}{姓名標示-相同方式分享 4.0 國際授權}（CC BY-SA 4.0），\footnote{\url{http://creativecommons.org/licenses/by-sa/4.0/deed.zh_TW}。}歡迎\href{http://goo.gl/foAeaq}{下載本投影片及練習資料檔案}。\footnote{\url{http://goo.gl/foAeaq}}以Adobe Reader開啟本PDF亦可取得練習資料檔案附件。}% 
    \vspace{10pt}
    }
}
