...
\usepackage{xcolor}
\definecolor{codecolor}{rgb}{0.0,0.3,0.0}
...
% frametitle
    \setbeamertemplate{frametitle}{\vspace*{-5pt}\insertframetitle\hspace*{\fill}{\scriptsize\insertpagenumber}\par}
%    \setbeamercolor{frametitle}{fg=black}

\setbeamersize{text margin left=0.6cm, text margin right=0.6cm}

\let\oldfootnote\footnote
\renewcommand\footnote[1]{\hspace{-0.6em}\oldfootnote{\ignorespaces#1}\hspace{0.3em}}
...
\setmainfont[Mapping=tex-text, Scale=0.8, LetterSpace=-2, BoldFont={DejaVu Sans}]{DejaVu Sans}
\setsansfont[Mapping=tex-text, Scale=0.8, LetterSpace=-2, BoldFont={DejaVu Sans}]{DejaVu Sans}
%\setmonofont[Color=codecolor, Scale=0.8, LetterSpace=-2, BoldFeatures={Color=white}, BoldFont={DejaVu Sans Mono}]{Inconsolata}
\setmonofont[Color=codecolor, Scale=MatchUppercase, LetterSpace=-1, BoldFeatures={Color=white}, BoldFont={Inconsolata}]{Inconsolata}

\usefonttheme{professionalfonts}

%% 中文字配置
\usepackage[
  CJKmath=true, indentfirst=false, PunctStyle={quanjiao}, CheckSingle=false, Verb=true, AutoFallBack=true, AutoFakeBold=false, AutoFakeSlant=false, 
]{xeCJK}

%\setCJKmainfont[Scale=1.0, BoldFont={Heiti TC Medium}]{Heiti TC Medium}
%\setCJKmonofont[Scale=0.9, BoldFont={DFYuanMedium-B5}, Color=codecolor]{DFYuanMedium-B5}
...
%\setCJKmonofont[Scale=0.95, BoldFont={Lantinghei TC}, Color=codecolor]{Lantinghei TC}

\setCJKmainfont[Scale=0.95, BoldFont={cwTeX Q Hei Bold}, LetterSpace=-20]{cwTeX Q Hei}
...
\item {\CJKfontspec[Scale=0.88]{WenQuanYi Zen Hei}《R语言实用教程》薛毅、陈立萍著，清华大学出版社。}
\item {\CJKfontspec[Scale=0.88]{WenQuanYi Zen Hei}《统计建模与R软件》薛毅、陈立萍著，清华大学出版社。} \\ 以數理統計為主，R語言實作為輔。
\end{itemize}
\end{frame}
