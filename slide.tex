...
\setmonofont[Color=codecolor, Scale=0.9, LetterSpace=-1, BoldFont={Fira Mono Medium},BoldFeatures={Color=white}]{Fira Mono Medium}
...
\setbeamertemplate{title page}{
  \vskip0pt plus 1filll
    ...
    {\tiny
        \parbox[c]{2.4cm}{% 
          \includegraphics[width=2.4cm]{by-sa.pdf}%
        }\hspace{6pt}%
        \parbox[c]{8.2cm}{% 
