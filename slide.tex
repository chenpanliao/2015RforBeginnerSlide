...
\setsansfont[Mapping=tex-text, LetterSpace=0, BoldFont={Lato Bold}, Scale=0.95]{Lato}
...
%\setmainfont[Mapping=tex-text, Scale=0.9, LetterSpace=0, BoldFont={DejaVu Sans}]{DejaVu Sans}
%\setsansfont[Mapping=tex-text, Scale=0.9, LetterSpace=0, BoldFont={DejaVu Sans Condensed}]{DejaVu Sans Condensed}
%\setmonofont[Color=verb, Scale=0.85, LetterSpace=-3, BoldFont={DejaVu Sans Mono},BoldFeatures={Color=white}]{DejaVu Sans Mono}
