...
\usepackage{xcolor}
\definecolor{codecolor}{rgb}{0.0, 0.4, 0.1}
...
% page number shown on top-right corner
    \setbeamertemplate{headline}{%
        \vskip5pt\hspace*{\fill}\insertpagenumber\hspace*{3pt}\vspace*{-10pt}%
    }
...
\setmainfont[Mapping=tex-text, Scale=0.825, LetterSpace=-0, BoldFont={DejaVu Sans}]{DejaVu Sans}
\setsansfont[Mapping=tex-text, Scale=0.825, LetterSpace=-0, BoldFont={DejaVu Sans}]{DejaVu Sans}
%\setmonofont[Color=codecolor, Scale=0.825, LetterSpace=-2, BoldFeatures={Color=white}, BoldFont={DejaVu Sans Mono}]{DejaVu Sans Mono}
\setmonofont[Color=codecolor, Scale=0.825, LetterSpace=-2, BoldFeatures={Color=white}, BoldFont={DejaVu Sans Mono}]{DejaVu Sans Mono}
