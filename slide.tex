...
\usepackage{xcolor}
\definecolor{verb}{rgb}{0.1,0.3,0.0}
...
%\setbeamertemplate{frametitle}{\vskip-0pt\hskip0cm\insertframetitle\par}
...
\setCJKmonofont[Scale=1, BoldFont={cwTeX Q Kai}, Color=verb]{cwTeX Q Kai}
