...
%\setbeamercolor{frametitle}{bg=red!5}
%\setbeamertemplate{frametitle}{\vskip-0.1cm\hskip-0.7cm\insertframetitle\par}
...
\setmainfont[Mapping=tex-text, LetterSpace=0]{PT Sans}
\setsansfont[Mapping=tex-text, LetterSpace=0]{PT Sans}
...
\setCJKmainfont[Scale=1]{cwTeX Q Yuan}
\setCJKmonofont[Scale=0.9,Color=verb]{cwTeX Q Yuan}
